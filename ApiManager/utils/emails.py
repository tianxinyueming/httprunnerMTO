...
from httprunnerMTO.settings import EMAIL_SEND_USERNAME, EMAIL_SEND_PASSWORD
...
if __name__ == '__main__':
    send_email_reports('##@qq.com, example@163.com', 'D:\\httprunnerMTO\\reports\\2018-06-05 15-58-00.html')
